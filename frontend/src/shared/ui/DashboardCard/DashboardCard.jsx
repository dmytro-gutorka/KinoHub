...
import ChartUpLineIcon from "../../icons/ChartUpLineIcon";
...
const DashboardCard = ({ children, dashStat, mainColor, label}) => {
    ...
    return (
        ...
        >
            ...
            <Box pl={1}>
                <Typography variant="h5" fontWeight="900">{dashStat}</Typography>
                <Typography variant="subtitle1" color={theme.palette[mainColor].light}>{label}</Typography>
