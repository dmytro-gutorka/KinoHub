...
export { default as MediaContentBlock } from '@shared/ui/BlockWrapper';
export { default as MediaCastAndCrew } from './ui/MediaCastAndCrew';
export { default as MediaDetails } from './ui/MediaDetails';
export { default as MediaRating } from './ui/MediaRating';
export { default as MediaPlot } from './ui/MediaPlot';
